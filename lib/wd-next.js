...
process.env.PATH = process.env.PATH + ':' + path.dirname(require('macaca-chromedriver').binPath);

var driver;
var _global;
var pureMethods = ['sendKeys', 'click', 'getTagName', 'getText', 'getInnerHtml', 'getCssValue', 'getAttribute', 'isDisplayed'];
